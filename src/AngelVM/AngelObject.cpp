...
namespace hgl
{
    ...
    bool AngelObject::BindProperty(const char *decl,int off)
    {
        ...
        LogError(U8_TEXT("%s"),
             (UTF8String("AngelObject::BindProperty(ObjectName=\"")+obj_name
              +UTF8String("\" property decl: ")+UTF8String(decl)).c_str());
        return(false);
    }
    ...
    bool AngelObject::BindFunc(const char *decl,void *addr)
    {
        ...
        LogError(U8_TEXT("%s"),
             (UTF8String("AngelObject::BindFunc(ObjectName=\"")+obj_name
              +UTF8String("\" func decl: ")+UTF8String(decl)).c_str());
        return(false);
    }
}//namespace hgl
