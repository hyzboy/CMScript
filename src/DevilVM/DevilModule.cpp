...
//              case ttDouble:
    ...
    */
    ...
    DevilFunc *DevilScriptModule::GetScriptFunc(const U16String &name)
    {
        DevilFunc *func;
    ...
    DevilFuncMap *DevilScriptModule::GetFuncMap(const U16String &name)
    {
        DevilFuncMap *func;
    ...
    DevilPropertyMap *DevilScriptModule::GetPropertyMap(const U16String &name)
    {
